...
stock_file = '/content/drive/MyDrive/Colab Notebooks/GitHub/weak_1_data/yfinance_data/yfinance_data/AMZN_historical_data.csv'
...
for stock_chunk in pd.read_csv('/content/drive/MyDrive/Colab Notebooks/GitHub/weak_1_data/yfinance_data/yfinance_data/AMZN_historical_data.csv',
